import MenyCard from "./assets/MenyCard.jsx";
...
function App() {
  ...
  return (
    <div>
      {meny.map((meny, id) => {
        return <MenyCard key={id} data={meny} />;
      })}
      <p></p>
    </div>
  );
